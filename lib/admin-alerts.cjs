...
// Testlerde izole dizine yönlendirilebilir. Bu modül olmadan alarm üreten
// her test gerçek admin-alerts.json'a yazar (yaşandı: mongo-health testi
// üretim dosyasına mongo_down/mongo_recovered kaydı düşürdü).
const DATA_DIR = process.env.SKORLIG_DATA_DIR || path.join(__dirname, "..", "data");
const FILE = path.join(DATA_DIR, "admin-alerts.json");
