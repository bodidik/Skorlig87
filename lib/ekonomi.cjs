...
const AYLIK_ESIK_10 = 10;
const AYLIK_ESIK_20 = 20;
const AYLIK_ODUL_10 = Number(process.env.SKORLIG_MONTHLY_BONUS_10 || 5);
const AYLIK_ODUL_20 = Number(process.env.SKORLIG_MONTHLY_BONUS_20 || 10);
...
module.exports = {
  ...
  GUNLUK_TABAN_SERI7,
  GUNLUK_TABAN_PREM,
  AYLIK_ESIK_10, AYLIK_ESIK_20, AYLIK_ODUL_10, AYLIK_ODUL_20,
  ACILIS_BAKIYESI,
