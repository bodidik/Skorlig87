...
const ULKELER = {
  ...
  // Maçkolik "Makau" gönderiyor (2026-08-02'de fikstürde görüldü, kapsam
  // testi yakaladı — testin yorumu haklıydı: yeni ad gelince tabloya eklenir).
  "Macau":          { flag: "🇲🇴", iso2: "MO", aliases: ["Makau", "Makao", "Macao"] },
   ...
   * şişirirdi. */
  // 2026-08-07: Maçkolik kapsamına iki yeni ülke girdi (src:"MK", Türkçe
  // yazımla). Tanınmayan ad "kendi ülkem" grubuna girmez — bkz. test notu.
  "North Macedonia": { flag: "🇲🇰", iso2: "MK", aliases: ["Kuzey Makedonya", "Makedonya", "Macedonia"] },
  "Bosnia and Herzegovina": { flag: "🇧🇦", iso2: "BA", aliases: ["Bosna-Hersek", "Bosna Hersek", "Bosnia", "Bosnia-Herzegovina"] },
  ...
  "Mongolia":       { flag: "🇲🇳", iso2: "MN", aliases: ["Moğolistan", "Mogolistan"] },
