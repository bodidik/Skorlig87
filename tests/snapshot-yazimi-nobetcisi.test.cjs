 ...
 * görünmüyor.
 *
 * ⚠️ DÖRT YOLDAN ÜÇÜNÜ DÜZELTMEK YETMEDİ: `settle` snapshot yazmaya devam
 * ettiği sürece ötekilerin atomik yazmalarını geri alıyordu. Bu yüzden kural
 * dosya bazında değil, ÇAĞRI bazında uygulanıyor.
 *
...
const MUAF = [
  ...
  },
  {
    ...
    gerekce:
      "BİLİNEN AÇIK, ayrı görev: tryAutoSettleTournaments hâlâ toptan yazıyor. " +
      "voided/settled iki ayrı yol olduğu ve payouts mühürden SONRA " +
      "hesaplandığı için düzeltme dikkat istiyor. Buraya muafiyet olarak " +
      "yazıldı ki nöbetçi kurulabilsin; düzeltilince bu girdi SİLİNMELİ.",
  },
];
